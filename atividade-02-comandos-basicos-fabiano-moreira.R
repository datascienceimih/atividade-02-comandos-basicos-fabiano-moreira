...
#Exercícios e atividades realizados na disciplina PROJETO INTEGRADOR dos cursos de 
#Ciências de Dados e Bioinformática do Centro Universitário Metodista Izabela Hendrix.
#Aluno: Fabiano Alves
#Github: https://github.com/fabiano-moreira
...
View(aula_programacao) #Exibe visualização gráfica do banco
...
str(aula_programacao) # Exibe a estrutura do banco
...
aula_programacao$cursos <- as.factor(aula_programacao$cursos) #altera a variável "cursos" 
#para factor
aula_programacao$times_futebol <- as.factor(aula_programacao$times_futebol) #altera a variável 
#"times_futebol" para factor
...
lista <- list(a, b, c, d, x, y, aula_programacao) #Exibindo uma lista com todas as variáveis
#criadas durante o exercício

print(lista) #Executa o comando "lista"

View(lista) #Exibe graficamente a "lista"

str(lista) #Exibe a estrutura da "lista"

class(lista) #Exibe a classe da lista. Neste caso, list.

class(lista[[5]]) #Exibe a classe específica do objeto que está pesquisando. Neste caso, a 
#posição "5" da lista é o objeto "x". Será exibido somente a classe dele.
